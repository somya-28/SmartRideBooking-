...
const FixedRouteMap = ({ pickupCoords, dropCoords, distance, duration }) => {
      ...
      <Box sx={{
        ...
        <Box sx={{ mt: 1 }}>
          <Box 
            ...
            onClick={() => pickupCoords && navigator.clipboard.writeText(`${pickupCoords.lat}, ${pickupCoords.lng}`)}
          >
          ...
          <Box 
            ...
            onClick={() => dropCoords && navigator.clipboard.writeText(`${dropCoords.lat}, ${dropCoords.lng}`)}
          >
